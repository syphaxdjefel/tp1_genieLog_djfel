...
class GildedRoseTest {
 ...
 static final String CLASSIC_ITEM = "Normal item";
 ...
 void basicItemQuality1() {
 final int quality = 50;
 final int sellIn = 2;
 final Item[] items = new Item[] {new Item(CLASSIC_ITEM, sellIn, quality)};
 ...
 //---------------------------------------sulfurassssssssssss-------------------------------------
 // La qualité de Sulfuras ne change pas quand quality > 0 et sellIn > 0
 @Test
 ...
 @Test
 // La qualite de Aged Brie ne peut dépasser 50 quand quality = 49 et sellIn < 0
 ...
 @Test
 // La qualite de Backstage ne peut pas dépasser 50 quand quality = 48 et 0 < sellIn <= 5
 ...
 @Test
 // La qualite de Backstage est à 0 quand sellIn <= 0 et quality > 0
...
//sellIn de Aged Brie diminue de 1 quand quality > 0
 ...
 //sellIn de Aged Brie diminue de 1 quand qualité <= 0
 @Test
 ...
 //sellIn de Aged Brie diminue de 1 quand qualité = 50
 @Test
 ...
 //sellIn de Aged Brie diminue de 1 quand qualité >0 et sellIn <= 0
 @Test
 ...
 int quality = 0;
 int sellIn = 11;
 Item[] items = new Item[] { new Item(BACKSTAGE_PASSES, sellIn, quality) };
 GildedRose app = new GildedRose(items);
 app.updateQuality();
 assertThat(app.items[0].sellIn, is(sellIn-1));
 }
